...
declare class eth_keyring_controller {
    ...
    createNewVaultAndKeychain(password: string): unknown;
...
declare namespace eth_keyring_controller {
    class EventEmitter {
