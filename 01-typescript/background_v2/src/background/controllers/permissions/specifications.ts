  ...
  return {
    [PermissionKeys.eth_accounts]: {
      ...
      methodImplementation: async (_args: any) => {
        ...
        return accounts.sort((firstAddress: any, secondAddress: any) => {
 ...
 */
function validateCaveatAccounts(accounts: any, getIdentities: any) {
 ...
 */
 export const unrestrictedMethods: any = Object.freeze([
  'eth_blockNumber',
  'eth_call',
  'eth_chainId',
  'eth_coinbase',
