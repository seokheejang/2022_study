...
async function start() {
  ...
  function initializeUi(activeTab: any, container: any, connectionStream: any, cb: any) {
    connectToAccountManager(connectionStream, (err: any, backgroundConnection: any) => {
      if (err) {
        cb(err, null);
        return;
      }
